...
CONFIG = code(
    ...
    "# ============================================================",
    "",
    "# CHECKPOINT: biarkan KOSONG untuk memakai Krea 2 Turbo resmi (paling stabil).",
    "# Mau pakai checkpoint-mu sendiri (Krea2_by_Rekty_Quantize_00001_.safetensors)?",
    "#   1) upload file ke HuggingFace (pastikan repo PUBLIC)",
    "#   2) salin URL file-nya, contoh:",
    "#      https://huggingface.co/NAMAMU/REPO/resolve/main/Krea2_by_Rekty_Quantize_00001_.safetensors",
    "#   3) tempel di bawah ini",
    'CHECKPOINT_URL = ""',
    "",
...
DOWNLOAD = code(
    ...
    "",
    "downloads = [",
    "    (CKPT_URL, COMFY + \"/models/diffusion_models/\" + ckpt_name),",
