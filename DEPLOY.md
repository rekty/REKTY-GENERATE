...
**BYOP (Bring Your Own Pollen):** mode login resmi Pollinations — tiap pengguna
memakai **pollen mereka sendiri**, bukan key milikmu. Alur: tombol **Login
dengan Pollinations** di panel API → authorize di enter.pollinations.ai
